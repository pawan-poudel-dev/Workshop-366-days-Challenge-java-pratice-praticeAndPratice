 ...
 *
 * <p>The default monthly quota starts at the value passed to the constructor.
 * Users can purchase additional prompts or submit prompts until the quota runs out.</p>
 *
 * @author  Pawan Poudel
 * @version 1.0
 * @see     AIModel
...
public class PersonalPlan extends AIModel {
    ...
    /** Remaining prompts in the monthly quota.  when a user enters a prompts it decrements by 1 on each submitted prompt. */
     ...
     * Rejects zero or negative values with an error message provided in the above section .
     *
     * @param prompts number of additional prompts to purchase; must be positive
     * @return confirmation message on success, or an error message if {@code prompts < 0}
     */
     ...
     * Returns a limit-reached message if the quota is exhausted or finished .
     *
     ...
     * Calls {@code super.display()} then appends the remaining prompt quota.
     *
